...
class PcscCsvActionForm extends ConfirmFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $entity_type_id = NULL) {
    ...
    $form['sheet'] = [
      '#type' => 'select',
      '#title' => $this->t('Workbook sheet'),
      '#description' => $this->t('Select the workbook sheet that you would like to export data for.'),
      '#options' => [
        'supplemental-528' => $this->t('Supplemental workbook: Prescribed Grazing (528)'),
      ],
      '#required' => TRUE,
    ];
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    // Create the file.
    $filename = $form_state->getValue('sheet') . '-' . date('c') . '.csv';
